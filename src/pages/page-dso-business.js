...
export default function   DSOBusinessSetup() {
  const main = useRef();
  ...
  return (
    <>
      <Helmet>
        <title>     DSO Business Setup Services in Dubai | Bizdoc Businessman Services


</title>
        <meta
          name="description"
          content=" Set up your business with DSO Business Setup Services in Dubai from Bizdoc Businessman Services, a leading business setup company in Dubai providing legal and tax & compliance services."
        />
        <meta
          name="keywords"
          content="dso business setup services in dubai, free zone company formation dubai, business setup company in dubai, legal services in dubai, tax & compliance services in dubai"
        />
        ...
        <div id="smooth-wrapper" ref={main}>
          <div id="smooth-content">
            <main className="main-bg">
              <Header title={"DSO Business Setup"} />
              <DSOBusinessSetupDubai/>
            </main>
            <Footer />
          </div>
        </div>
