...
import DocumentAttestationServices from '../components/page-services-details/Document Attestation Services';
gsap.registerPlugin(useGSAP, ScrollTrigger);
export default function PageDocumentAttestationServices() {
  const main = useRef();
        ...
        <div id="smooth-wrapper" ref={main}>
          <div id="smooth-content">
            <main className="main-bg o-hidden">
              <Header title={"Document Attestation "} />
