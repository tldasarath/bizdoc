...
import BusinessSetupServices from '../components/page-services-details/BusinessSetupServices';
import TaxComplianceServices from '../components/page-services-details/TaxComplianceServices';
import TrademarkRegistrationServices from '../components/page-services-details/TrademarkRegistrationServices';
gsap.registerPlugin(useGSAP, ScrollTrigger);
export default function PageTrademarkRegistrationServices() {
  const main = useRef();
        ...
        <div id="smooth-wrapper" ref={main}>
          <div id="smooth-content">
            <main className="main-bg o-hidden">
              <Header title={"Trademark Registration "} />
