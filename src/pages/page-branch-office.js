...
export default function   BranchOfficeSetup() {
  ...
  return (
    <>
      <Helmet>
        <title>    Branch Office Setup Services in Dubai | Bizdoc Businessman Services


</title>
        <meta
          name="description"
          content="Bizdoc Businessman Services provides Branch Office Setup Services in Dubai. Leading business setup company in Dubai offering professional legal and tax & compliance services in Dubai."
        />
        <meta
          name="keywords"
          content="  branch office setup services in dubai, mainland company formation dubai, business setup company in dubai, legal services in dubai, tax & compliance services in dubai"
        />
        ...
        <div id="smooth-wrapper" ref={main}>
          <div id="smooth-content">
            <main className="main-bg">
              <Header title={" Branch office setup "} />
              <BranchOfficeSetupDubai/>
            </main>
            <Footer />
          </div>
        </div>
