...
import OffshoreCompanyFormationDubai from '../components/business-setup/OffshoreCompanyFormationDubai';
gsap.registerPlugin(useGSAP, ScrollTrigger);

export default function   OffshoreCompanyFormation() {
  const main = useRef();
  ...
  return (
    <>
      <Helmet>
        <title>  Offshore Company Formation Services in Dubai | Bizdoc Businessman Services

</title>
        <meta
          name="description"
          content=" Get professional Offshore Company Formation Services in Dubai with Bizdoc Businessman Services, a leading business setup company in Dubai offering legal and tax & compliance services in Dubai."
        />
        <meta
          name="keywords"
          content=" Offshore Company Formation Services in Dubai, business setup company in Dubai, legal services in Dubai, tax & compliance services in Dubai, company registration Dubai"
        />
