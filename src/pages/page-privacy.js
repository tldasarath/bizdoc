...
import Header from '../components/page-privacy/Header';
...
import PrivacyPolicy from '../components/page-privacy/privacy';
...
export default function Privacy() {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy – Bizdoc UAE | Data Protection & Security</title>
        <meta
          name="description"
          content="Learn how Bizdoc protects your personal and business data in UAE. Our privacy policy covers data collection, usage, sharing, security measures, cookies, and your rights while using our business setup, visa, PRO, and legal services."
        />
        <meta
          name="keywords"
          content="Bizdoc Privacy Policy UAE, Data Protection UAE, Business Data Security UAE"
        />
