...
export default function   LicenseRenewalServices() {
  const main = useRef();
  ...
  return (
    <>
      <Helmet>
        <title>     License Renewal Services in Dubai | Bizdoc Businessman Services


</title>
        <meta
          name="description"
          content=" Ensure uninterrupted operations with License Renewal Services in Dubai by Bizdoc Businessman Services. Leading business setup company in Dubai offering expert legal and tax & compliance services in Dubai."
        />
        <meta
          name="keywords"
          content="license renewal services in dubai, pro services dubai, business setup company in dubai, legal services in dubai, tax & compliance services in dubai
"
        />
        ...
        <div id="smooth-wrapper" ref={main}>
          <div id="smooth-content">
            <main className="main-bg">
              <Header title={"License Renewal Services"} />
              <LicenseRenewalServicesDubai/>
            </main>
            <Footer />
          </div>
        </div>
