...
import GoldenVisaServices from '../components/page-services-details/GoldenVisaServices ';
import EndToEndBusinessSupport from '../components/page-services-details/EndToEndBusinessSupport';
gsap.registerPlugin(useGSAP, ScrollTrigger);
export default function PageEndToEndBusinessSupport() {
  const main = useRef();
        ...
        <div id="smooth-wrapper" ref={main}>
          <div id="smooth-content">
            <main className="main-bg o-hidden">
              <Header title={"End-To-End Business"} />
