...
export default function   DICCompanyFormation() {
  const main = useRef();
  ...
  return (
    <>
      <Helmet>
        <title>     DIC Company Formation Services in Dubai | Bizdoc Businessman Services


</title>
        <meta
          name="description"
          content=" Bizdoc Businessman Services provides DIC Company Formation Services in Dubai. Leading business setup company in Dubai with professional legal and tax & compliance services in Dubai."
        />
        <meta
          name="keywords"
          content="dic company formation services in dubai, free zone company setup dubai, business setup company in dubai, legal services in dubai, tax & compliance services in dubai"
        />
        ...
        <div id="smooth-wrapper" ref={main}>
          <div id="smooth-content">
            <main className="main-bg">
              <Header title={"DIC Company Formation"} />
              <DICCompanyFormationDubai/>
            </main>
            <Footer />
          </div>
        </div>
