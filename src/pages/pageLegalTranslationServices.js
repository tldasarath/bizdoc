...
import LegalTranslationServices from '../components/page-services-details/LegalTranslationServices';
gsap.registerPlugin(useGSAP, ScrollTrigger);
export default function PageLegalTranslationServices() {
  const main = useRef();
        ...
        <div id="smooth-wrapper" ref={main}>
          <div id="smooth-content">
            <main className="main-bg o-hidden">
              <Header title={"Legal Translation "} />
