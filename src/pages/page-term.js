...
import Header from '../components/page-terms/Header';
...
import TermsConditions from '../components/page-terms/terms';
...
export default function Terms() {
  ...
  return (
    <>
      <Helmet>
        <title>Terms & Conditions – Bizdoc UAE | Business Setup Services</title>
        <meta
          name="description"
          content="Read Bizdoc’s Terms & Conditions for using our website and services in UAE. Covers business setup, PRO services, visas, Golden Visa, document attestation, bank account opening, legal support, and compliance guidance."
        />
        <meta
          name="keywords"
          content="Bizdoc Terms UAE, Business Setup Terms UAE, Legal Disclaimer UAE"
        />
