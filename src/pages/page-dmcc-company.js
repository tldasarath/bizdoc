...
export default function   DMCCCompanySetup() {
  const main = useRef();
  ...
  return (
    <>
      <Helmet>
        <title>    DMCC Company Setup Services in Dubai | Bizdoc Businessman Services


</title>
        <meta
          name="description"
          content="Establish your business with DMCC Company Setup Services in Dubai through Bizdoc Businessman Services, a leading business setup company in Dubai offering legal and tax & compliance services."
        />
        <meta
          name="keywords"
          content="dmcc company setup services in dubai, free zone company formation dubai, business setup company in dubai, legal services in dubai, tax & compliance services in dubai"
        />
        ...
        <div id="smooth-wrapper" ref={main}>
          <div id="smooth-content">
            <main className="main-bg">
              <Header title={" DMCC Company Setup "} />
              <DMCCCompanySetupDubai/>
            </main>
            <Footer />
          </div>
        </div>
