...
export default function   CorporatePROServices() {
  const main = useRef();
  ...
  return (
    <>
      <Helmet>
        <title>     Corporate PRO Services in Dubai | Bizdoc Businessman Services


</title>
        <meta
          name="description"
          content=" Bizdoc Businessman Services offers Corporate PRO Services in Dubai. Leading business setup company in Dubai providing government approvals, legal services, and tax & compliance services in Dubai."
        />
        <meta
          name="keywords"
          content="corporate pro services in dubai, government approvals services dubai, business setup company in dubai, legal services in dubai, tax & compliance services in dubai
"
        />
        ...
        <div id="smooth-wrapper" ref={main}>
          <div id="smooth-content">
            <main className="main-bg">
              <Header title={"Corporate PRO Services"} />
              <CorporatePROServicesDubai/>
            </main>
            <Footer />
          </div>
        </div>
