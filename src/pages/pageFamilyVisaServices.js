...
import FamilyVisaServices from '../components/page-services-details/FamilyVisaServices';
gsap.registerPlugin(useGSAP, ScrollTrigger);
export default function PageFamilyVisaServices() {
  const main = useRef();
