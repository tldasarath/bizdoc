...
import BankAccountOpeningServices from '../components/page-services-details/BankAccountOpeningServices';
gsap.registerPlugin(useGSAP, ScrollTrigger);
export default function PageBankAccountOpeningServices() {
  const main = useRef();
