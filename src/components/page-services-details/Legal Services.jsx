...
function LegalServices() {
  ...
  const service = {
    ...
    ServicesOffered: {
      ...
      "Corporate and Compliance Services": "UAE companies must follow strict laws on labor, tax, and operations. We support you with legal compliance checks, company policies, and corporate governance to avoid penalties and maintain smooth operations.",
    ...
    CallToAction: "Protect your business and personal interests with professional legal support. Contact Bizdoc today for comprehensive legal services tailored to your needs in the UAE."
  };

  const serviceKey = "LegalServicesAndAssistanceInUAE";
      ...
      <div className="container">
        ...
        <div className="row mb-60">
          <div className="col-12">
            <div className="img-full fit-img rounded-lg overflow-hidden">
              <img src="/assets/images/services/legal.png" alt={serviceKey} className="w-75" />
            </div>
          </div>
        </div>
        ...
        <div className="row mb-50">
          <div className="col-12">
            ...
            <h1 className="mb-30 fw-600">Legal Services & Legal Assistance in <span className='main-color'>UAE</span></h1>
        ...
        <div className="row">
          <div className="col-lg-8">
            ...
            {service.WhyLegalSupportIsEssential && (
              <div className="service-section mb-50">
                <h3 className="mb-30 fw-500">Why Legal Support is Essential in the <span className='main-color'>UAE</span></h3>
                <div className="row">
                  <div className="col-12">
                    <p className="mb-0">{service.WhyLegalSupportIsEssential}</p>
                  </div>
                </div>
              </div>
            )}
