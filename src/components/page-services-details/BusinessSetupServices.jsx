...
function BusinessSetupServices() {
  ...
  const service = {
    ...
    TypesOfBusinessSetupInUAE: {
      "Mainland Company Formation": "We help you establish a mainland business in Dubai and across the UAE, giving you access to the local market and the flexibility to work with government and private entities.",
      "Free Zone Company Formation": "If you want 100% ownership and a cost-effective setup, our free zone company setup services in UAE are the ideal solution. We guide you in selecting the right free zone based on your industry and goals.",
      "Offshore Company Formation": "Looking for international trade or asset protection? We provide offshore company formation services in UAE, ensuring complete confidentiality and legal compliance."
    },
  ...
  const serviceKey = "BusinessSetupServicesInUAE";
      ...
      <div className="container">
        ...
        <div className="row mb-50">
          <div className="col-12">
            ...
            <h1 className="mb-30 fw-600">Business Setup Services In <span className='main-color'>UAE</span></h1>
        ...
        <div className="row">
          <div className="col-lg-8">
            ...
            {service.TypesOfBusinessSetupInUAE && (
              <div className="service-section mb-50">
                <h3 className="mb-30 fw-500">Types of Business Setup in <span className='main-color'>UAE</span></h3>
                <div className="types-list-container  p-4 rounded">
                  {Object.entries(service.TypesOfBusinessSetupInUAE).map(([typeName, typeDesc], index, array) => (
            ...
            {service.WhyChooseBizdoc && (
              <div className="service-section mb-50">
                <h3 className="mb-30 fw-500">Why Choose Bizdoc for Business Setup in <span className='main-color'>UAE</span></h3>
                <div className="row">
                  <div className="col-12">
            ...
            {service.CallToAction && (
              <div className="service-section mb-50">
                <div className="cta-box bg-main-color text-white p-4 rounded">
                  <h4 className="mb-3">Begin Your Business Setup in <span className='main-color'>UAE</span> Today</h4>
