...
function BankAccountOpeningServices() {
  ...
  const service = {
    ...
    HowWeHelp: "This is where Bizdoc steps in. Our experts have years of experience working with UAE banks and can make the process smooth and predictable.",
    OurServicesCover: {
  ...
  const serviceKey = "BankAccountOpeningServicesInUAE";
      ...
      <div className="container">
        ...
        <div className="row mb-60">
          <div className="col-12">
            <div className="img-full fit-img rounded-lg overflow-hidden">
              <img src="/assets/images/services/bank.png" alt={serviceKey} className="w-75" />
            </div>
          </div>
        </div>
        ...
        <div className="row mb-50">
          <div className="col-12">
            ...
            <h1 className="mb-30 fw-600">Bank Account Opening Services in <span className='main-color'>UAE</span></h1>
          ...
          <div className="col-lg-8">
            ...
            {service.Challenges && (
              <div className="service-section mb-50">
                <h3 className="mb-30 fw-500">Challenges of Opening a Bank Account in <span className='main-color'>UAE</span></h3>
                <div className="row">
                  <div className="col-12">
